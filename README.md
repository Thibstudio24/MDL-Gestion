...
* **Aucun build frontend** — pas de Node, pas de Sass, pas de Tailwind, pas de CDN, pas de
  ...
  ~10 Ko de JS vanilla et Chart.js servi en local.
...
| Trésorerie | grand livre, comptes (banque / coffre), comptages de caisse, clôtures mensuelles, import Excel/CSV, bilan annuel Excel |
| Planning de la salle | campagnes de disponibilités (semaine 1 / semaine 2), couverture, PDF A4 paysage, échanges |
| Planning de ménage | sondage, répartition automatique équitable, suivi avec preuve photo supprimée à la validation |
| Messagerie | diffusions descendantes, accusés de lecture, relances, envoi différé, file d'attente en base |
...
Puis ouvrir <http://127.0.0.1:8000/installation/> et suivre l'assistant en six étapes.
...
* [`docs/CAHIER-DES-CHARGES.md`](docs/CAHIER-DES-CHARGES.md) — spécification complète
* [`docs/MODE-EMPLOI.md`](docs/MODE-EMPLOI.md) — 26 sections + FAQ + glossaire + check-list
* [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) — modèle de données, droits, services
* [`docs/SECURITE-CONFORMITE.md`](docs/SECURITE-CONFORMITE.md) — sécurité et RGPD
* [`docs/HUB-EDITEUR.md`](docs/HUB-EDITEUR.md) — canal éditeur, interventions, mises à jour
