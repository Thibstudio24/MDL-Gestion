...
ACTIONS = [
    ...
    "settings.year_unlocked", "settings.legal_updated", "centrale.instance_added",
    "centrale.instance_deleted", "centrale.action_queued",
    "auth.instance_blocked", "auth.instance_unblocked", "settings.maintenance", "settings.backup_created",
