...
ACTIONS = [
    ...
    "finance.import_reverted", "finance.balance_generated", "finance.account_updated", "finance.exported",
    ...
    "chores.campaign_created", "chores.campaign_published", "chores.response_saved", "chores.generated",
